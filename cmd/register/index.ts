import { Contract, Signer, TransactionReceipt, getAddress } from 'ethers'
...
export async function register(
  ...
  console.log(
    `Margin account ${color.bgBlack(color.green(account))} registered in transaction ${color.bgBlack(
      color.yellow(receipt.hash),
    )}`,
  )
  return { account, treasure }
}
